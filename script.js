...
document.getElementById("ig").addEventListener("click", () =>{
    window.location.href = "https://www.instagram.com/allieh.28/?hl=en";
});
document.getElementById("sc").addEventListener("click", () =>{
    window.location.href = "https://snapchat.com/t/ralhHCZa";
});
document.getElementById("linkedin").addEventListener("click", () => {
    window.location.href = "https://www.linkedin.com/in/allison-hoang-75b638325/";
});
